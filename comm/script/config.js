...
module.exports = {
    ...
    hotTag: ['动作', '喜剧', '爱情', '悬疑'],
    bannerList: [
        {type:'film', id: '26683290', imgUrl: url + '/images/banner_1.jpg', search: '', keyword: ''},
        {type:'film', id: '25793398', imgUrl: url + '/images/banner_2.jpg', search: '', keyword: ''},
        {type:'film', id: '26630781', imgUrl: url + '/images/banner_3.jpg', search: '', keyword: ''},
        {type:'film', id: '26415200', imgUrl: url + '/images/banner_4.jpg', search: '', keyword: ''},
        {type:'film', id: '3025375', imgUrl: url + '/images/banner_5.jpg', search: '', keyword: ''}
    ],
    skinList: [
